...
/*
** This file contains definition of response of
** IDE_CMD_IDENTIFY_DEVICE or IDE_CMD_IDENTIFY_PACKET_DEVICE
** respectively
*/

// TODO
// - remove hex offsets / word index
...
typedef struct tagdevice_infoblock {
	...
	uint16 dummy102[23];		// cc (104)
	
	LBITFIELD2 (				// fe (127) RMSN support
