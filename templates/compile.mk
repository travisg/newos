...
$(MY_TARGETDIR_IN)/%.d: MY_CPPFLAGS_IN:=$(MY_CPPFLAGS_IN)
...
$(MY_TARGETDIR_IN)/%.o: $(MY_SRCDIR_IN)/%.cpp 
	$(MKDIR)
	$(CC) -c $< $(GLOBAL_CPPFLAGS) $(MY_CPPFLAGS_IN) $(MY_INCLUDES_IN) -o $@

$(MY_TARGETDIR_IN)/%.d: $(MY_SRCDIR_IN)/%.cpp
	$(MKDIR)
	$(DEPSMSG)
	@($(ECHO) -n $(dir $@); $(CC) $(GLOBAL_CPPFLAGS) $(MY_CPPFLAGS_IN) $(MY_INCLUDES_IN) -M -MG $<) > $@
