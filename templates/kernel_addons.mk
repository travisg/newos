...
MY_DEPS_IN := $(MY_DEPS)
MY_LIBS_IN := $(LIBKERNEL) $(MY_LIBS)
MY_LINKSCRIPT_IN := $(MY_LINKSCRIPT)

ifeq ($(MY_LINKSCRIPT_IN), )
	MY_LINKSCRIPT_IN := $(KERNEL_ADDONS_DIR)/ldscripts/$(ARCH)/addon.ld
endif
...
$(MY_TARGET_IN): $(_TEMP_OBJS) $(MY_DEPS_IN) $(MY_LIBS_IN)
	@$(MKDIR)
	@echo linking $@
	$(NOECHO)$(LD) $(GLOBAL_LDFLAGS) -Bdynamic -shared -Bsymbolic -T $(MY_LINKSCRIPT_IN) -L $(LIBGCC_PATH) -o $@ $(_TEMP_OBJS) $(MY_LIBS_IN) $(LIBGCC)
